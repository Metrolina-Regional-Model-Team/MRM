...
# Display as nicely formatted HTML table
library(readxl)     # For reading Excel files
library(knitr)      # For rendering tables
library(kableExtra) # For styling tables

data_taz <- read_excel("C:/MRM/docs/other/xlsx/TAZ Summary.xlsx")
data_taz %>%
  ...
  row_spec(0, background = "#d9d9d9", bold = TRUE)  # Gray header background
