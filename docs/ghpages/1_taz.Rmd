...
The table below summarizes the Traffic Analysis Zones (TAZs) across MRM region for MRM22v3.0 and map below shows the changes made in the TAZ structure moving from 3,578 TAZs in MRM22v1.0 to 3,896 TAZs in MRM25v3.0 
