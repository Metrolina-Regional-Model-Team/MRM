...
The table below summarizes the model's current TAZ structure. The map below shows the changes made with the most recent major model update, moving from 3,578 TAZs in MRM22v1.0 to 3,896 TAZs in MRM25v1.0.
