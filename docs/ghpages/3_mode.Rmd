...
knitr::include_graphics("../other/png/work.png")
```
...
**Tree Structure**
```{r, out.width="80%", fig.show='hold',fig.align='center'}
knitr::include_graphics("../other/png/other.png")
```
...
**Tree Structure**
```{r, out.width="80%", fig.show='hold',fig.align='center'}
knitr::include_graphics("../other/png/school.png")
```
...
**Tree Structure**
```{r, out.width="80%", fig.show='hold',fig.align='center'}
knitr::include_graphics("../other/png/subtour.png")
```
