...
knitr::include_graphics("C:/MRM/docs/other/png/work.png") 
```
...
**Tree Structure**
```{r, echo=FALSE, out.width="100%", fig.align="center"}
knitr::include_graphics("C:/MRM/docs/other/png/other.png") 
```
...
**Tree Structure**
```{r, echo=FALSE, out.width="100%", fig.align="center"}
knitr::include_graphics("../other/png/uni.png")
...
**Tree Structure**
```{r, echo=FALSE, out.width="100%", fig.align="center"}
knitr::include_graphics("C:/MRM/docs/other/png/school.png") 
```
...
**Tree Structure**
```{r, echo=FALSE, out.width="100%", fig.align="center"}
knitr::include_graphics("C:/MRM/docs/other/png/subtour.png") 
```
