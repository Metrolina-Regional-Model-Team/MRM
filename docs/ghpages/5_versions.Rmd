...
The following sections describe the current travel demand model versions available for download and use. Each model version reflects a specific set of planning assumptions, data inputs, and transportation projects and has been developed in accordance with the model update and versioning framework described above.
...
**This is the current working model.**This model was prepared for the North Carolina Department of Transportation (NCDOT) for development of the 2055 Metropolitan Transportation Plans (MTP’s) of the following jurisdictions:
