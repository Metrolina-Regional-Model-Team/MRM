...
invisible(capture.output({
  ...
  mpo_rpo_boundary <- st_read("C:/MRM/docs/other/shps/Boundaries/MPO_RPO.shp")
...
## Model Team & Planning and Applications Oversight Committee
...
* Catawba Regional Council of Governments (Catawba COG)
